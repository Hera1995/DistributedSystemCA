...
public final class LightingControlServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<LightingControlServiceProto.LightControlRequest,
      LightingControlServiceProto.LightControlResponse> getMonitorAndControlLightsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MonitorAndControlLights",
      requestType = LightingControlServiceProto.LightControlRequest.class,
      responseType = LightingControlServiceProto.LightControlResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<LightingControlServiceProto.LightControlRequest,
      LightingControlServiceProto.LightControlResponse> getMonitorAndControlLightsMethod() {
    io.grpc.MethodDescriptor<LightingControlServiceProto.LightControlRequest, LightingControlServiceProto.LightControlResponse> getMonitorAndControlLightsMethod;
      ...
      synchronized (LightingControlServiceGrpc.class) {
        if ((getMonitorAndControlLightsMethod = LightingControlServiceGrpc.getMonitorAndControlLightsMethod) == null) {
          LightingControlServiceGrpc.getMonitorAndControlLightsMethod = getMonitorAndControlLightsMethod =
              io.grpc.MethodDescriptor.<LightingControlServiceProto.LightControlRequest, LightingControlServiceProto.LightControlResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MonitorAndControlLights"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  LightingControlServiceProto.LightControlRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  LightingControlServiceProto.LightControlResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<LightingControlServiceProto.LightControlRequest> monitorAndControlLights(
        io.grpc.stub.StreamObserver<LightingControlServiceProto.LightControlResponse> responseObserver) {
  ...
  public static final class LightingControlServiceStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<LightingControlServiceProto.LightControlRequest> monitorAndControlLights(
        io.grpc.stub.StreamObserver<LightingControlServiceProto.LightControlResponse> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              LightingControlServiceProto.LightControlRequest,
              LightingControlServiceProto.LightControlResponse>(
